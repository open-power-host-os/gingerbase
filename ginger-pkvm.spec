%if 0%{?fedora} >= 15 || 0%{?rhel} >= 7 || 0%{?base_major_version} >= 15
%global with_systemd 1
%endif


%define ibm_release .9
Name:		ginger
Version:	1.3.0.1
...
git checkout --track remotes/origin/pkvm-3.1
...
%{_datadir}/kimchi/plugins/ginger/ui/pages/help/*/host-admin.html
%{_sysconfdir}/kimchi/plugins.d/ginger.conf


%changelog
* Tue Dec 30 2014 Rodrigo Trujillo <rodrigo.trujillo@linux.vnet.ibm.com> 1.3.0
- Created ginger-pkvm spec file
